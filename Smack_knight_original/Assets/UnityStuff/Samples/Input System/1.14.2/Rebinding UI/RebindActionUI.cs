...
namespace UnityEngine.InputSystem.Samples.RebindUI
{
    ...
    public class RebindActionUI : MonoBehaviour
    {
        ...
        private void PerformInteractiveRebind(InputAction action, int bindingIndex, bool allCompositeParts = false)
        {
            ...
            // Disable actions to prevent errors
            action.Disable();
            ...
            m_RebindOperation = action.PerformInteractiveRebinding(bindingIndex)
                ...
                .OnComplete(
                    operation =>
                    {
                        ...
                        if (FindDuplicateBinding(action, bindingIndex, allCompositeParts))
                        {
                            action.RemoveBindingOverride(bindingIndex);
                            CleanUp();
        ...
        private bool FindDuplicateBinding(InputAction action, int bindingIndex, bool allCompositeParts = false)
        {
            InputBinding newBinding = action.bindings[bindingIndex];
            ...
            foreach (InputBinding binding in action.actionMap.bindings)
            {
                ...
                if(binding.effectivePath == newBinding.effectivePath){
                    ...
                    Debug.Log("Duplicat binding found: " + newBinding.effectivePath);
                    return true;
                }
            }
        ...
        [Tooltip("Optional bool field which allows yuo to OVERRIDE the action label with you own text")]
